...
<style>
html,body,h1,h2,h3,h4,h5 {font-family: "Trebuchet MS", Arial, Helvetica, sans-serif}
...
<br>
  <div class="container-fluid">
    <div class="wrapper">    
        <div class="w3-padding-large w3-padding-32 w3-margin-top" style="text-align: center; background-color: #5ccb5f">
                        ...
                        <div class="w3-row">
                            ...
                            <div class="w3-col m6">
                                    ...
                                    <div class="form-group <?php echo (!empty($dosis_puestas_err)) ? 'has-error' : ''; ?>">
                                        ...
                                        <input type="text" name="dosis_puestas" class="form-control" style="width: 300px;" value="0" readonly><br>
                                    ...
                                    <div class="form-group <?php echo (!empty($fecha_dosis_err)) ? 'has-error' : ''; ?>">
                                        ...
                                        <input style="width: 300px;" type="text" id="datefield" name="fecha_dosis" min='1899-01-01' max='2000-13-13' class="form-control w3-light-grey" value="<?php echo $fecha_dosis; ?>" readonly><br>
                            ...
                            <a href="inicio.php" class="w3-dosis_puestas w3-button" style="margin-left: 5px;">Cancelar</a>
                        </div>
                    </form>
            </div>
        </div>    
