...
<br>
  <div class="container-fluid">
    <div class="wrapper">    
        <div class="w3-white w3-padding-large w3-padding-32 w3-margin-top" style="text-align: center; background-color: #5ccb5f !important;">
                            ...
                            <div class="w3-col m6">  
                                ...
                                <div class="form-group <?php echo (!empty($vacuna_err)) ? 'has-error' : ''; ?>">
                                    ...
                                    <select name="vacuna" style="width: 300px;"class="form-control">
                                            <option value="<?php echo $vacuna ?>"><?php echo $vacuna ?></option>
                                            <?php                            
                                ...
                                <div class="form-group <?php echo (!empty($centro_vacunacion_err)) ? 'has-error' : ''; ?>">
                                    ...
                                    <select name="centro_vacunacion" style="width: 300px;"class="form-control">
                                            <option value="<?php echo $centro_vacunacion ?>"><?php echo $centro_vacunacion ?></option>
                                            <?php                            
                                ...
                                <a href="tabla_vacunas.php" class="w3-dosis_puestas w3-button" style="margin-left: 5px;">Cancelar</a>
                            </div>
                        </div>        
                     </form>
            </div>
