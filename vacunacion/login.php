                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            if($rol== "Visitante Anonimo") { 
                                header("location: tabla_vacunas_individual.php");
                            } 
                            if($rol== "Empleado de Salud") { 
                                header("location: tabla_vacunas.php");
                            } 
...
<head>
    ...
    <style type="text/css">
        ...
        @media screen and (max-width:400px) {
            .wrapper {
                width:500px; /* The width is 100%, when the viewport is 800px or smaller */
            }
        }
...
<body>
    <div class="wrapper vertical-center" style="background-color: #5ccb5f; color: white;">
